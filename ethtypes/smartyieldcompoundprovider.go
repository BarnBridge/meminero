...
func (d *SmartYieldCompoundProviderDecoder) SmartYieldCompoundProviderTransferFeesEventID() common.Hash {
	return common.HexToHash("0x9f87918b63a7c3c287a77288ad6cb96549e9af160ef33eb03880fd127ed46deb")
}

func (d *SmartYieldCompoundProviderDecoder) IsSmartYieldCompoundProviderTransferFeesEvent(log *types.Log) bool {
	if len(log.Topics) == 0 {
		return false
	}
	return log.Topics[0] == d.SmartYieldCompoundProviderTransferFeesEventID()
}

func (d *SmartYieldCompoundProviderDecoder) SmartYieldCompoundProviderTransferFeesEventW3(w3l web3types.Log) (SmartYieldCompoundProviderTransferFeesEvent, error) {
	l, err := ethgen.W3LogToLog(w3l)
	if err != nil {
		return SmartYieldCompoundProviderTransferFeesEvent{}, err
	}

	return d.SmartYieldCompoundProviderTransferFeesEvent(l)
}

func (d *SmartYieldCompoundProviderDecoder) SmartYieldCompoundProviderTransferFeesEvent(l types.Log) (SmartYieldCompoundProviderTransferFeesEvent, error) {
	var out SmartYieldCompoundProviderTransferFeesEvent
	if !d.IsSmartYieldCompoundProviderTransferFeesEvent(&l) {
