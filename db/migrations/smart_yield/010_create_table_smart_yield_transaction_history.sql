...
create table smart_yield.transaction
(
...
create index tx_history_user_address_idx
    on smart_yield.transaction (user_address asc, block_timestamp desc, tx_index desc, log_index desc);


---- create above / drop below ----

drop table if exists smart_yield.transaction;
