...
create or replace function smart_yield.number_of_seniors(_pool_address text) returns bigint
    language plpgsql as
$$
declare
    value bigint;
...
create or replace function smart_yield.number_of_juniors_locked(_pool_address text) returns bigint
    language plpgsql as
$$
declare
    value bigint;
...
create or replace function smart_yield.junior_liquidity_locked(_pool_address text) returns numeric(78)
    language plpgsql as
$$
declare
    value numeric(78);
begin
    ...
    where b.pool_address = _pool_address;
