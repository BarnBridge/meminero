...
drop function if exists smart_yield.current_owner_of_token_at_ts;
drop function if exists smart_yield.senior_bond_value_at_ts;
drop function if exists smart_yield.senior_bond_redeemed_at_ts;
drop function if exists smart_yield.senior_underlying_price_at_ts;
drop function if exists smart_yield.senior_portfolio_at_ts;
drop function if exists smart_yield.senior_portfolio_value_at_ts;