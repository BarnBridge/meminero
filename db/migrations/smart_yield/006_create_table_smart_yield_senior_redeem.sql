...
create index senior_redeem_events_senior_bond_address_id_idx
    on smart_yield.senior_redeem_events (senior_bond_address asc, senior_bond_id asc, block_timestamp desc);

create index senior_redeem_events_user_address_idx
    on smart_yield.senior_redeem_events (owner_address);
