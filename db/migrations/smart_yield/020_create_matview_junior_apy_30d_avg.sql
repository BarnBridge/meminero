create materialized view smart_yield.junior_apy_30d_avg as
...
create unique index smart_yield_junior_apy_30d_avg_pool_address_idx_unique on smart_yield.junior_apy_30d_avg (pool_address);
