create or replace function governance.proposal_votes(id bigint) returns table (user_id text ,support boolean ,block_timestamp bigint,power numeric(78))
    language plpgsql as
$$
begin
    return query
        select distinct v.user_id,
                        ...
                        v.power
        from governance.governance_votes v
        where proposal_id = id
          and ( select count(*)
                from governance.governance_votes_canceled vc
