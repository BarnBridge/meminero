create or replace function governance.abrogation_proposal_votes(id bigint) returns table (user_id text ,support boolean ,block_timestamp bigint,power numeric(78))
    language plpgsql as
$$
begin
    return query
