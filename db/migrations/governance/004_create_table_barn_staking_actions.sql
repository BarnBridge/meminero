...
(
    ...
    block_timemstamp  bigint                 not null,
...
create index user_balance_idx
    on governance.barn_staking_actions (user_address asc, included_in_block desc, log_index desc);

create index barn_staking_actions_included_in_block_idx
    on governance.barn_staking_actions (included_in_block desc);
