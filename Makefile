...
sync-avalanche: meminero
	./meminero sync --syncer.network avalanche --syncer.datasets smart-alpha-pools,tokens

sync-bsctestnet: meminero
	./meminero sync --syncer.network bsctestnet --syncer.datasets smart-alpha-pools,tokens

sync-bsc: meminero
	./meminero sync --syncer.network bsc --syncer.datasets smart-alpha-pools,tokens

sync-arbitrumrinkeby: meminero
	./meminero sync --syncer.network arbitrumrinkeby --syncer.datasets smart-alpha-pools,tokens

sync-arbitrum: meminero
	./meminero sync --syncer.network arbitrum --syncer.datasets smart-alpha-pools,tokens
