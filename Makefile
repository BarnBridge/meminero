...
sync-mainnet: meminero
	./meminero sync  --config config-sync-fwd.yml --syncer.network mainnet --syncer.datasets labels,monitored-accounts,monitored-erc20,smart-alpha-pools,smart-alpha-reward-pools,smart-exposure-pools,smart-yield-pools,smart-yield-reward-pools,tokens
